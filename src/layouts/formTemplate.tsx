...
export default function FormTemplate(props: IFormTemplate) {
    ...
    return (
        ...
        <div className='btnGroup mt-5'>  
            <ScratchForm formType="Classic" onClick = {() => handleClick("Classic")} formDescription="Show All Question On One Page"></ScratchForm>
            <ScratchForm formType="Card" onClick={()=> handleClick('Card')} formDescription="Show Each Question On different Page"></ScratchForm>
        </div>
